...
CON_stan_fit_CO2 <- model$sample(data = data_list, seed = 1234, refresh = 10, init = init_theta, iter_sampling = 5000, iter_warmup = 1000, chains = num_chains, parallel_chains = num_chains, adapt_delta = 0.95)

#Save Stan fit object and NUTS inference results.
CON_stan_fit_CO2$save_object(file = "NUTS_results/CON_CO2_NUTS_inference_SCON-SS_data.rds")
...
write_csv(CON_stan_fit_CO2_post, "NUTS_results/CON_CO2_NUTS_inference_SCON-SS_data_post.csv")
CON_stan_fit_CO2_post_pred <- as_tibble(CON_stan_fit_CO2$draws(("y_hat_post_pred"), format = "draws_df"))
write_csv(CON_stan_fit_CO2_post_pred, "NUTS_results/CON_CO2_NUTS_inference_SCON-SS_data_post_pred.csv")
...
write_csv(CON_stan_fit_CO2_summary, "NUTS_results/CON_CO2_NUTS_inference_SCON-SS_data_post_and_post_pred_summary.csv")
